...
import { KNOWN_KINDS, parseRecord, pickRecords, type ParsedRecord } from '../core/records'
 ...
 */
export function useRecords(address: string | undefined | null, index: number | undefined | null, kinds: readonly string[] | null = KNOWN_KINDS, armoredKey?: string | null) {
