...
/** PGPRegistry v3. Deployed with CREATE2, so the address is the same on every network. */
export const REGISTRY_ADDRESS = '0x4f2d70799cAAD651C7c564426AA74A842c1331B6' as const
